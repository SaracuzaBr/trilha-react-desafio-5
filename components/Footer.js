...
export default function Footer({ copyrightText }) {
  ...
  return (
    <footer className="py-16 flex flex-col items-center border-t border-gray-300 dark:border-gray-700 mt-12">
      {/* Redes Sociais */}
      <div className="mb-8">
        <p className="text-sm font-semibold text-gray-700 dark:text-gray-300 mb-4">Siga-nos</p>
        <div className="flex gap-6 justify-center">
          ...
          >
            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
              <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.475-2.236-1.986-2.236-1.081 0-1.722.722-2.004 1.418-.103.249-.129.597-.129.946v5.441h-3.554s.05-8.831 0-9.749h3.554v1.381c.432-.666 1.202-1.608 2.923-1.608 2.136 0 3.74 1.395 3.74 4.393v5.583zM5.337 8.855c-1.144 0-1.915-.762-1.915-1.715 0-.955.77-1.715 1.967-1.715 1.195 0 1.914.76 1.939 1.715 0 .953-.744 1.715-1.991 1.715zm1.582 11.597H3.635V9.558h3.284v10.894zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.225 0z" />
            </svg>
          </a>
          <a
      ...
      <div className="text-center mb-6">
        <p className="dark:text-white uppercase mb-2 font-bold opacity-60 text-sm">
          {copyrightText}
        </p>
        <p className="text-xs text-gray-600 dark:text-gray-400">
          © {currentYear}. Desenvolvido com ❤️ para a comunidade DIO.
        </p>
      </div>
